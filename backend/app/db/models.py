from sqlalchemy import Column, String, Integer, Boolean, Date, DateTime, Numeric, ForeignKey, CheckConstraint, UniqueConstraint
...
class RationCard(Base):
    ...
    household_head_name = Column(String)
...
class MonthlyAllocation(Base):
    ...
    __table_args__ = (UniqueConstraint('ration_card_id','month_year',name='_rc_month_uc'),)
...
class GrievanceCase(Base):
    ...
    voice_testimony_r2_key = Column(String)
