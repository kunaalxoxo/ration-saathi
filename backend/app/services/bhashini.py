    ...
    async def text_to_speech(self, text: str, language: str = 'hi') -> bytes:
        try:
                ...
                "pipelineTasks": [
                    {
                        ...
                        "config": {
                            ...
                            "serviceId": "ai4bharat/indic-tts--gpu-u4b", 
                            "gender": "female"
                        }
                    }
                ], 
            ...
            async with httpx.AsyncClient(timeout=10.0) as client:
                ...
                if resp.status_code == 200:
                    return base64.b64decode(resp.json()['pipelineResponse'][0]['audio'][0]['audioContent'])
                ...
                "pipelineTasks": [
                    {
                        ...
                        "config": {
                            "language": {"sourceLanguage": language}, 
                            "serviceId": "ai4bharat/whisper-medium-en-hi--gpu-u4b", 
                            "audioFormat": "wav", 
                            "samplingRate": 8000
                        }
                    }
